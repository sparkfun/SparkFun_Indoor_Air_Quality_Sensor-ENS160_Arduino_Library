...
// setCommunicationBus()
//
// Overloaded option for setting the data bus (theBus) object to a SPI bus
// object.
//
//  Parameter    Description
//  ---------    -----------------------------
...
// readRegisterRegion()
//
// Reads data from the given register, auto-incrementing fore each successive
// read
//
//  Parameter    Description
//  ---------    -----------------------------
...
// setRHCompensation()
//
// The ENS160 can use relative Humidiy data to help give more accurate sensor
// data.
//
//  Parameter    Description
//  ---------    -----------------------------
